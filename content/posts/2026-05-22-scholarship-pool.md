---
title: "How We Choose Families for the Scholarship Pool"
slug: "how-we-choose-scholarship-families"
excerpt: "What our Families First scholarship covers, how we decide who receives subsidized services, and how families can request consideration."
category: "Community"
published: true
...
The scholarship is need-based and capacity-bound. We accept families based on three factors:

**1. The family's documented financial constraint.** We do not require tax returns or formal income documentation. We ask the family to describe their situation in their own words. Single parents working multiple jobs, families with a child in long-term medical care, families recently displaced by housing instability, families with a parent who is themselves disabled and on fixed income: these are the situations we hear most often. The standard is honesty, not paperwork.

**2. The urgency of the child's need.** A child whose IEP meeting is two weeks away takes priority over a child whose meeting is six months away. A child who has been struggling for years without proper intervention takes priority over a routine annual review. A child whose 504 or IEP was recently changed without family input takes priority over a child whose plan is working but could be stronger.

**3. The current scholarship pool balance.** We are honest with families about this. The scholarship pool is funded entirely by donations and grants. When the pool is at capacity, we maintain a waitlist and place new families as soon as funding comes in. We never turn a family away. We tell them what the wait is, and we honor it.

## How to request a scholarship

There is one step. Contact Dr. Clarke-Wedderburn before booking a service:

- Email: info@edquityatthemargins.org
- Phone: (786) 810-6178

In your initial message, share:

- Your child's age and grade
- The service you are interested in
- A brief description of your situation
- Whether you have an upcoming IEP meeting and the date

We respond within 24 to 48 business hours with a recommendation. If a full scholarship is available, we say so. If a partial scholarship is the right fit, we offer a sliding-scale rate. If the pool is at capacity, we tell you the expected wait and add you to the list. No family is judged. No family is asked to prove they need help.
