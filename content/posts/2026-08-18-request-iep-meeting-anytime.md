---
title: "You Do Not Have to Wait for the Annual Review"
slug: "request-iep-meeting-anytime"
excerpt: "Most families believe the IEP meeting happens once a year on the school's calendar. Federal law sets that annual review as a minimum, and a parent can ask the team to reconvene whenever the Program stops matching the child."
category: "Advocacy"
published: true
...
**Progress has stalled or reversed.** If the data shows your child is not on pace to meet a goal, the regulation's first named trigger applies. If the progress report contains no data at all, [that is its own problem](/news/how-to-read-iep-progress-reports), and a meeting is where you raise it.
...
If the district declines to meet, the refusal is connected to a potential change in your child's Program, and you can ask for the refusal in writing under 34 C.F.R. § 300.503. [We have written about how Prior Written Notice works](/news/prior-written-notice-when-school-says-no) and why a documented refusal is more useful than a verbal one. Districts asked to put a refusal on paper frequently find a meeting date instead.
