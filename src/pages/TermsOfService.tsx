      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="prose prose-lg prose-headings:text-primary prose-p:text-muted-foreground prose-li:text-muted-foreground prose-a:text-accent max-w-none">
            ...
            <p>Edquity at the Margins serves marginalized families of children with disabilities. Our family services, including the IEP Audit, the Advocacy Toolkit, our Know Your Rights workshops, and EDquity Scholars, are provided at no cost to families; EDquity Scholars seats are funded by sponsors and donors. The specific services delivered to each family are determined through the intake process and confirmed in writing prior to service delivery. Edquity at the Margins also provides consulting services to schools, districts, and local education agencies, including independent blind IEP quality audits, the EDquity Leader Fellowship, and educator professional development; those engagements are governed by separate written agreements, and these Terms of Service apply to family services and general use of this website.</p>
            <h3>1.1 IEP Audit</h3>
            ...
            <h2>2. Fees</h2>
            <p>Our family services are provided free of charge, and they always will be. No family is ever charged for a service, and EDquity Scholars seats are funded by sponsors and donors. The organization is supported by donations, grants, and revenue from its consulting services to schools and systems, and a share of every consulting fee is designated to keep our free services free.</p>
