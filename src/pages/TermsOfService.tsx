      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="prose prose-lg prose-headings:text-primary prose-p:text-muted-foreground prose-li:text-muted-foreground prose-a:text-accent max-w-none">
            ...
            <p>Edquity at the Margins serves marginalized families of children with disabilities. The IEP Audit, the Advocacy Toolkit, and our Know Your Rights workshops are provided at no cost. Our other family services, including our multi-week courses and our one-to-one advocacy services, carry a fee that is published on the relevant service page, and the Families First Scholarship reduces or waives that fee for families who qualify. The specific services delivered to each family are determined through the intake process and confirmed in writing prior to service delivery. Edquity at the Margins also provides consulting services to schools, districts, and local education agencies, including independent blind IEP quality audits, the EDquity Leader Fellowship, and educator professional development; those engagements are governed by separate written agreements, and these Terms of Service apply to family services and general use of this website.</p>
            <h3>1.1 IEP Audit</h3>
            ...
            <h2>2. Fees</h2>
            <p>The IEP Audit, the Advocacy Toolkit, and our Know Your Rights workshops are provided free of charge, and they always will be. Our multi-week courses and our one-to-one advocacy services carry a fee, which is published on the relevant service page, disclosed before enrollment, and confirmed in writing. No family is charged for any service without agreeing to the fee in advance. The Families First Scholarship reduces or waives program fees for families who qualify, and eligibility is determined through the scholarship application. The organization is further supported by donations, grants, and revenue from its consulting services to schools and systems, and a share of every consulting fee is designated to keep our free services free.</p>
