        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We opened intake in May 2026 and deliver audits for families across multiple states, with a median of three days from request to report. We led our first workshop in July 2026 at the Gallatin Public Library and lead monthly Know Your Rights webinars.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg prose-p:text-muted-foreground prose-headings:text-primary max-w-none">
              ...
              <p>
                <strong>EDquity at the Margins addresses that gap directly.</strong> Parents hold knowledge about their children that no evaluation instrument can replicate, and our work translates that knowledge into legally binding education programs through document analysis and sustained advocacy support.
              </p>
            </div>
          </div>
        </div>
