        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <motion.div
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.8)", lineHeight: 1.75, margin: "0 0 24px", maxWidth: 760 }}>
              An IEP review is one point in time: a family learns something, goes back into the system alone, and nobody finds out whether anything changed. EDquity Scholars is what we built in response. Thirty students in grades 8 through 12 spend a year with us, from a five-day July intensive through nine Saturdays and two campus visits to a May celebration where every Scholar presents. Students build the executive functioning skills the system keeps writing goals about and rarely teaches, explore careers against real wage data, and practice speaking in their own IEP meetings, while their parents build the same advocacy muscle in workshops on the same days. Each child's IEP is audited at enrollment and again in May, so the year ends with evidence, not impressions.
            </p>
