      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="prose prose-lg prose-headings:text-primary prose-p:text-muted-foreground prose-li:text-muted-foreground prose-a:text-accent max-w-none">
            ...
            <p>For our free family services, Edquity at the Margins receives educational records directly from parents and legal guardians, who have the right under FERPA to access and share their child's educational records. All family records are submitted voluntarily by the parent or guardian following completion of the intake process and receipt of a signed consent authorizing us to receive and review those records.</p>

            <h2>Documents Received from Schools and LEAs</h2>
            <p>In our consulting engagements, schools and local education agencies submit documents for evaluation only after permanently removing all personally identifiable information, following our written Redaction Guidance. Because these documents are fully de-identified before transmission, they are not disclosures of personally identifiable information under FERPA, and parental consent is not required for the institution to share them. The submitting institution retains sole responsibility for the adequacy of its redactions, and Edquity at the Margins rejects and securely deletes any document received that contains unredacted personally identifiable information.</p>
            ...
            <p>Educational records are transmitted over encrypted connections and stored in access-controlled, encrypted cloud storage. Access to educational records is limited to staff and contractors directly involved in service delivery. Records are retained for a minimum of three years following the conclusion of services and are securely deleted or destroyed thereafter. Parents and guardians may request deletion of their records at any time, subject to applicable legal retention requirements.</p>
