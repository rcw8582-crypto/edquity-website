...
const principles = [
  "Our independent IEP Audit is free, our Know Your Rights workshops are free, and our Advocacy Toolkit and My Child's Playbook are free to download. EDquity Scholars seats are funded by sponsors and free to every family, with seats limited by available funding.",
          ...
          <div className="md-grid-split">
            <div>
              ...
              <p style={{ fontSize: 16, color: "#475569", lineHeight: 1.7, margin: 0 }}>
                Our free services stay free because paid work with schools and districts, sponsorships, and donations underwrite them, and because our founder contributes the majority of the professional time the organization runs on without pay. As a newly founded organization, we will publish our full financial statements with each annual 990 filing rather than post projections before we have a year of actual spending to report.
              </p>
