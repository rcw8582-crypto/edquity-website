...
import { upcoming, past, googleCalendarUrl, icsFileContents, type EdatmEvent } from "@/content/events";
            ...
            {upcoming.map((event, i) => (
              ...
              >
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                  <a href={event.rsvpUrl ?? "/contact"}
                    target={event.rsvpUrl ? "_blank" : undefined}
                    rel={event.rsvpUrl ? "noopener noreferrer" : undefined}
              ...
              {past.map((p, i) => (
                <div key={i} style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 12, padding: "20px 24px" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                    <span style={{ fontSize: 12, color: "#64748b" }}>{p.dateLabel}</span>
